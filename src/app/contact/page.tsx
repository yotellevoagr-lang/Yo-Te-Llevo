...
import { Mail, Phone, MapPinIcon, Clock, Instagram, Facebook, QrCode, MessageSquare } from "lucide-react"
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-8 pt-4">
                <div className="space-y-6 p-6 border bg-muted/20 rounded-lg">
                  <InfoRow icon={MapPinIcon} label="Dirección" value={contact?.address} href={contact?.addressLink} />
                  <InfoRow icon={MessageSquare} label="WhatsApp" value={contact?.phone} href={whatsappLink} />
