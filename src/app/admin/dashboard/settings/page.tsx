...
import { Upload, Settings as SettingsIcon, Bus, Trash2, Edit, PlusCircle, Ship, Plane, Save, MapPin, Loader2, Pin, Contact, Utensils, BedDouble, Folder, ShieldCheck, KeyRound, Mail, Eye, EyeOff, Image as ImageIcon, Globe } from "lucide-react"
import type { CustomLayoutConfig, LayoutCategory, GeneralSettings, GeoSettings, BoardingPoint, ContactSettings, Pension, RoomType, Employee, DomainSettings } from "@/lib/types"
...
export default function SettingsPage() {
    ...
    const handleSaveLogo = async () => {
        ...
        try {
            ...
            setLogoFile(null); // Clear the file state after successful upload
        } catch (error) {
